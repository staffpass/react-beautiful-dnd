...
var getValueFromDistance = (function (distanceToEdge, thresholds, config) {
...
var dampenValueByTime = (function (proposedScroll, dragStartTime, config) {
...
var getValue = (function (_ref) {
  var distanceToEdge = _ref.distanceToEdge,
      ...
      config = _ref.config;
  var scroll = getValueFromDistance(distanceToEdge, thresholds, config);
...
var getScrollOnAxis = (function (_ref) {
  var distanceToEdges = _ref.distanceToEdges,
      dragStartTime = _ref.dragStartTime,
      axis = _ref.axis,
      shouldUseTimeDampening = _ref.shouldUseTimeDampening,
      type = _ref.type,
  ...
  var startCaptureBinding = useMemo(function () {
    return {
      ...
      fn: function onTouchStart(event) {
        ...
        !dragHandleId ? process.env.NODE_ENV !== "production" ? invariant(false, 'Touch sensor unable to find drag dragHandleId') : invariant(false) : void 0;
...
function useDroppablePublisher(args) {
  ...
  var descriptor = useMemo(function () {
    return {
      ...
      type: args.type,
      mode: args.mode,
      autoScrollConfig: _extends({}, config, {}, args.autoScrollConfig)
    };
